...
class OCCViewer(QWidget, ComponentMixin):
    ...
    preferences = Parameter.create(
        ...
        children=[
            ...
            {
                "name": "Center view on double-click",
                "type": "bool",
                "value": True,
            },
        ],
    ...
    def updatePreferences(self, *args):
        ...
        # Whether double-clicking recenters the view on the picked point
        self.canvas.set_center_on_double_click(
            self.preferences["Center view on double-click"]
        )
